...
public:
    ...
    static constexpr uint32_t VGA_BASE   = 0xB8000000;
    ...
    void loadProgram(const std::vector<uint32_t>& instruction, uint32_t address = 0);
    void loadData(const std::vector<uint8_t>& data, uint32_t address);
